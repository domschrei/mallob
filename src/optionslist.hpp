...
OPTION_GROUP(grpJob, "job", "Global configuration of jobs")
 ...
 OPT_BOOL(crossJobToClientParent, "cjtcp", "cross-job-to-client-parent", true, "Allow the AnytimeCommunicator to send cross-job shared clauses to its client parent")
