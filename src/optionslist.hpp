...
OPT_INT(finalHardLbdLimit,               "fhlbd", "",                       0,    0, LARGE_INT,         "After max. number of clause prod. increases, this MUST be fulfilled for any clause to be shared")
OPT_INT(finalSoftLbdLimit,               "fslbd", "",                       0,    0, LARGE_INT,         "After max. number of clause prod. increases, this must be fulfilled for any clause to be shared except for special cases")
...
OPT_INT(initialHardLbdLimit,             "ihlbd", "",                       0,    0, LARGE_INT,         "Before any clause prod. increase, this MUST be fulfilled for any clause to be shared")
OPT_INT(initialSoftLbdLimit,             "islbd", "",                       0,    0, LARGE_INT,         "Before any clause prod. increase, this must be fulfilled for any clause to be shared except for special cases")
