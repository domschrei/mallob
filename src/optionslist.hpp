...
OPT_INT(finalHardLbdLimit,               "fhlbd", "final-hard-lbd-limit",             LARGE_INT, 0, LARGE_INT, "After max. number of clause prod. increases, this MUST be fulfilled for any clause to be shared")
OPT_INT(finalSoftLbdLimit,               "fslbd", "final-soft-lbd-limit",             LARGE_INT, 0, LARGE_INT, "After max. number of clause prod. increases, this must be fulfilled for any clause to be shared except for special cases")
...
OPT_INT(hardMaxClauseLength,             "hmcl", "hard-clause-length-limit",          30,   0, LARGE_INT,      "Only share clauses up to this length")
...
OPT_INT(initialHardLbdLimit,             "ihlbd", "init-hard-lbd-limit",              LARGE_INT, 0, LARGE_INT, "Before any clause prod. increase, this MUST be fulfilled for any clause to be shared")
OPT_INT(initialSoftLbdLimit,             "islbd", "init-soft-lbd-limit",              LARGE_INT, 0, LARGE_INT, "Before any clause prod. increase, this must be fulfilled for any clause to be shared except for special cases")
...
OPT_INT(softMaxClauseLength,             "smcl", "soft-clause-length-limit",          30,   0, LARGE_INT,      "Only share clauses up to this length except for special cases")
...
OPT_FLOAT(increaseClauseProductionRatio, "icpr", "clause-prod-increase-ratio",        0,    0, 1,              "Increase a solver's Clause Production when it fills less than <ratio> of its buffer")
...
OPT_STRING(satSolverSequence,            "satsolver",  "",                            "L",                     "Sequence of SAT solvers to cycle through (capital letter for true incremental solver, lowercase for pseudo-incremental solving): L|l:Lingeling C|c:CaDiCaL g:Glucose k:Kissat m:MergeSAT")
