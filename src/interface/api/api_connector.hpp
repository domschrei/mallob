...
public:
    ...
    */
    JsonInterface::Result submit(const nlohmann::json& data, std::function<void(nlohmann::json&)> callback = CALLBACK_IGNORE);
    ...
    */
    nlohmann::json processBlocking(const nlohmann::json& input);
    ...
    */
    std::promise<nlohmann::json> processAsync(const nlohmann::json& input);
};
