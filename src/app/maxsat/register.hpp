...
void register_mallob_app_maxsat() {
    ...
    entry.copyrightInformation = "by Dominik Schreiber, Teemu Koukkari, and Jeremias Berg"
#if MALLOB_USE_MAXPRE
        "\nc Featuring MaxPRE preprocessor by Tuukka Korhonen, modified by Jeremias Berg and Dominik Schreiber"
#endif
        "\nc Featuring RustSAT by Christoph Jabs\n";
