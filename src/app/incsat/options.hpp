...
OPT_INT(nontrivialSolvingDelay, "nsd", "nontrivial-solving-delay", 15, 0, LARGE_INT, "Milliseconds to wait with non-trivial solving if an internal stream processor is present (-isp=1)")
