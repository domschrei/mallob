#ifndef MSCHICK_CUBE_GENERATOR_THREAD_MANAGER_INTERFACE_H
#define MSCHICK_CUBE_GENERATOR_THREAD_MANAGER_INTERFACE_H
...
#endif /* MSCHICK_CUBE_GENERATOR_THREAD_MANAGER_INTERFACE_H */