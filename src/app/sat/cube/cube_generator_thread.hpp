...
#include "cube_generator_thread_manager_interface.hpp"
#include "dynamic_cube_setup.hpp"

class CubeGeneratorThread {
   private:
    CubeGeneratorThreadManagerInterface &_manager;
   ...
   public:
    CubeGeneratorThread(CubeGeneratorThreadManagerInterface &manager, DynamicCubeSetup &setup);
    ~CubeGeneratorThread();
