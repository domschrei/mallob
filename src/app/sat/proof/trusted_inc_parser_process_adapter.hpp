...
class TrustedIncParserProcessAdapter {
...
public:
    TrustedIncParserProcessAdapter(int baseSeed, const std::string& name) : _base_seed(baseSeed), _name(name), _f_buf(1<<14) {}
    ~TrustedIncParserProcessAdapter() {
