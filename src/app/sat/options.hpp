...
OPTION_GROUP(grpAppSatProof, "app/sat/proof", "Production of UNSAT proofs")
 ...
 OPT_BOOL(produceParallelProof,           "ppp", "produce-parallel-proof",             false,                   "Enhancement to -otfc=1 which, in combination, makes use of advanced ImpCheck parallel proof production")
