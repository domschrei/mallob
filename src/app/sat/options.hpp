...
OPTION_GROUP(grpAppSatProof, "app/sat/proof", "Production of UNSAT proofs")
 ...
 OPT_BOOL(onTheFlyCheckModel,             "otfcm", "on-the-fly-check-model", false, "Also check satisfiable assignment in on-the-fly checking (prevents deletion of original clauses)")
