...
OPTION_GROUP(grpAppSatProof, "app/sat/proof", "Production of UNSAT proofs")
 ...
 OPT_BOOL(otfcExternalId,                 "extid", "on-the-fly-checking-id",           false,                   "Enable for PLRAT on-the-fly checking; PLRAT on-the-fly checker modifies clause IDs for clause sharing")
