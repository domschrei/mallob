...
bool LockfreeClauseDatabase::addClause(int producerId, const Clause& c) {
...
UniformSizeClauseRingBuffer& LockfreeClauseDatabase::getBuffer(int clauseSize, int lbd) {
    size_t index = 0;
