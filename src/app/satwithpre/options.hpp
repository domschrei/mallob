...
OPT_INT(preprocessBalancing, "pb", "preprocess-balancing", 1, 0, 2, "How to balance original vs. preprocessed task: 0=drop original immediately, 1=replace original gradually, 2=run both indefinitely")
