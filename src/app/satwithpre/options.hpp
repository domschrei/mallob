...
OPT_FLOAT(preprocessSweepPriority, "psp", "preprocess-sweep-priority", 1.123f, 0.0001f, LARGE_INT, "Job priority to assign to the SWEEP job, running parallel to the Base SAT Job")
