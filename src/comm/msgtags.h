...
const int MSG_SEND_CLIENT_DIRECTIVE_TO_JOB_TREE_ROOT = 100;
const int MSG_SEND_APP_DATA_TO_JOB_TREE_ROOT = 101;
const int MSG_SEND_APP_DATA_TO_CLIENT_JOB = 102;
...
const int MSG_NOTIFY_READY_FOR_PROOF_SAFE_SHARING = 424;

const int MSG_REQUEST_HISTORIC_CLAUSES = 425;
const int MSG_FORWARD_HISTORIC_CLAUSES = 426;
