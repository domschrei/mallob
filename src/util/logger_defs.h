...
#define LOG_RETURN_FALSE(VERB, ...) LOGGER_LOG(Logger::getMainInstance().log_return_false, VERB, VERB, __VA_ARGS__)
...
#define LOGGER_RETURN_FALSE(LOGGER, VERB, ...) LOGGER_LOG(LOGGER.log_return_false, VERB, VERB, __VA_ARGS__)
