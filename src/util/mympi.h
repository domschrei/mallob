 ...
 */
const int ALL_TAGS[] = {
    MSG_FIND_NODE_ONESHOT, MSG_FIND_NODE, MSG_WORKER_FOUND_RESULT, MSG_FORWARD_CLIENT_RANK, MSG_JOB_DONE, 
    MSG_ANYTIME_REDUCTION, MSG_ANYTIME_BROADCAST, MSG_COLLECTIVES,
    MSG_CLIENT_FINISHED, MSG_INCREMENTAL_JOB_FINISHED,
    MSG_ONESHOT_DECLINED, MSG_OFFER_ADOPTION, MSG_ACCEPT_ADOPTION_OFFER, MSG_REJECT_ADOPTION_OFFER, 
 ...
 */
const int ANYTIME_WORKER_RECV_TAGS[] = {MSG_FIND_NODE_ONESHOT, MSG_FIND_NODE, MSG_WORKER_FOUND_RESULT, 
            ...
            MSG_TERMINATE, MSG_INTERRUPT, MSG_ABORT, MSG_WORKER_DEFECTING, 
            MSG_RESULT_OBSOLETE, MSG_JOB_DONE,
