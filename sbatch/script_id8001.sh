...
mpiexec.hydra --bootstrap slurm ${MPIRUN_OPTIONS} -n ${SLURM_NTASKS} build/mallob scenarios/scenario_all_c4 -c=4 -l=0.950 -t=4 -T=3700 -lbc=4 -time-per-instance=0 -cpuh-per-instance=10.000 -derandomize -ba=8 -g=1 -md=0 -p=0.100 -s=1 -v=4 -warmup -jjp -cg -r=bisec -bm=ed -yield -log=mallob_logs/mallob_id8001_26x10x2_3720s
echo finished
