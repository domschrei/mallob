...
# HOME
globallogdir_base=logs/hwtest3-$SLURM_JOB_ID
# WORK
...
localtmpdir_base=/tmp/hwtest3-$SLURM_JOB_ID # fast local disk
...
ndone=$(echo sbatch/generated/hwtest3/.done.* | wc -w)
ntotal=$((8 - 0 + 1))
...
echo "I" >> sbatch/generated/hwtest3/.ticks
if [ $(cat sbatch/generated/hwtest3/.ticks|wc -l) -gt $ntotal ]; then exit; fi
...
for i in $(seq 0 8 | shuf) ; do
    ...
    # already done? -> skip
    if [ -d sbatch/generated/hwtest3/.done.$i ] ; then continue; fi
    ...
    if [ -d sbatch/generated/hwtest3/.reserved.$i ] && ! [[ $(find sbatch/generated/hwtest3/.reserved.$i -newermt "8 minutes ago") ]]; then
        # reservation is old (>8 minutes) - reset it
        rmdir sbatch/generated/hwtest3/.reserved.$i
    fi
    # unable to get a reservation? -> skip
    if ! mkdir sbatch/generated/hwtest3/.reserved.$i 2> /dev/null ; then continue; fi
    ...
    mkdir -p sbatch/generated/hwtest3/.done.$i
...
sbatch --begin=now`#+$((360+30))` sbatch/generated/hwtest3/sbatch.sh
