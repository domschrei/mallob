...
# HOME
globallogdir_base=logs/hwtest5-$SLURM_JOB_ID
# WORK
...
localtmpdir_base=/tmp/hwtest5-$SLURM_JOB_ID # fast local disk
...
ndone=$(echo sbatch/generated/hwtest5/.done.* | wc -w)
ntotal=$((8 - 0 + 1))
...
echo "I" >> sbatch/generated/hwtest5/.ticks
if [ $(cat sbatch/generated/hwtest5/.ticks|wc -l) -gt $ntotal ]; then exit; fi
...
for i in $(seq 0 8 | shuf) ; do
    ...
    # already done? -> skip
    if [ -d sbatch/generated/hwtest5/.done.$i ] ; then continue; fi
    ...
    if [ -d sbatch/generated/hwtest5/.reserved.$i ] && ! [[ $(find sbatch/generated/hwtest5/.reserved.$i -newermt "8 minutes ago") ]]; then
        # reservation is old (>8 minutes) - reset it
        rmdir sbatch/generated/hwtest5/.reserved.$i
    fi
    # unable to get a reservation? -> skip
    if ! mkdir sbatch/generated/hwtest5/.reserved.$i 2> /dev/null ; then continue; fi
    ...
    mkdir -p sbatch/generated/hwtest5/.done.$i
...
sbatch --begin=now`#+$((60+30))` sbatch/generated/hwtest5/sbatch.sh
