...
mpiexec.hydra --bootstrap slurm ${MPIRUN_OPTIONS} -n ${SLURM_NTASKS} build/mallob scenarios/scenario_all_c1 -ba=8 -bm=ed -c=1 -cbbs=1500 -cbdf=0.7 -cg -cpuh-per-instance=50 -derandomize -g=1 -jjp -l=0.95 -lbc=4 -log=mallob_logs/mallob_evaltest01_103x5x4_600s -md=0 -p=0.1 -q -r=bisec -s=1 -s2f=mallob_logs/mallob_evaltest01_103x5x4_600s/solution -sleep -T=600 -t=4 -time-per-instance=0 -v=4 -warmup
echo finished
